...
import { CleanLink, Info, MapGrid, SmallIcon, Title } from './styles';
    ...
    <Grid container my={{ xs: 2, md: 4, xl: 8 }} mx={{ xs: 4, md: 6, xl: 10 }} spacing={4}>
      ...
      <MapGrid size={12}>
        ...
        <CleanLink
          ...
          target="_blank"
          rel="noopener noreferrer">
          <Info zIndex={300} margin="0 10px -28px" position="relative">
            ver no Google Maps
          </Info>
        </CleanLink>
      </MapGrid>
      <Grid size={12} textAlign="center"></Grid>
    </Grid>
  );
}
